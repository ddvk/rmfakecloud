...
// readRootIndex reads the root hash and generation from the history file without locking.
// Callers must ensure proper locking.
func readRootIndex(historyPath string) (string, int64, error) {
...
func (fs *FileSystemStorage) GetRootIndex(uid string) (string, int64, error) {
	...
	return readRootIndex(historyPath)
}
